...
const COMMANDS: Record<string, string[]> = {
  help: [
    ...
    "  how it works - Explain the TreeTrace pipeline",
  ...
  "how it works": [
    ...
    "",
    "  01 UPLOAD SPECIMEN",
    "     Upload a high-resolution top-down image. Works best with",
    "     clean, sanded surfaces.",
    "",
    "  02 MARK THE PITH",
    "     Identify the biological center. The CS-TRD algorithm uses",
    "     this origin to project radial gradients outwards.",
    "",
    "  03 LET AI DECODE",
    "     Automated pipeline detects ring boundaries, validates",
    "     continuously, and extracts exact chronological widths.",
    "",
    "  04 ANALYZE RESULTS",
    "     Review ring count, estimated age, climatic growth trends,",
    "     and health scores in interactive visualization panels.",
    "",
  ],
  how: [
    "Typo? Try: 'how it works'",
  ],
  sections: [
    "01  Ring Detection",
    "02  Age Estimation",
